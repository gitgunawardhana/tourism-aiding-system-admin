    ...
    return (
        <>
            <div className="lower-nav-bar">
                <p className="title">Bathroom Facilities</p>
                <p className="sub-title">Configurations / Bathroom Facilities</p>
            </div>
            <div className='main-section'>
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={9}>
                            <TextField
                                ...
                                id="bathroom-facility-search"
                                label="Search Bathroom Facilities"
                                variant="outlined"
                            />
                        </Grid>
                        <Grid item xs={3}>
                ...
                {isFormOpen && <BathroomFacilityForm
